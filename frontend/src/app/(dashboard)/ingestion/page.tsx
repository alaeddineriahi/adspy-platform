...
export default function IngestionPage() {
  ...
  const loadConfig = useCallback(async () => {
    try {
      const r = await fetch(`${API_URL}/api/ingestion/config`);
  ...
  const loadStatus = useCallback(async () => {
    try {
      const r = await fetch(`${API_URL}/api/ingestion/status`);
  ...
  const saveCookie = async () => {
    ...
    setCookieMsg("");
    try {
      const r = await fetch(`${API_URL}/api/ingestion/session`, {
        method: "POST",
        headers: { "Content-Type": "application/json" },
  ...
  const saveCurl = async () => {
    ...
    setCurlMsg("");
    try {
      const r = await fetch(`${API_URL}/api/ingestion/search-template`, {
        method: "POST",
        headers: { "Content-Type": "application/json" },
